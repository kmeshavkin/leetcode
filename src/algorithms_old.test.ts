...
describe("Sum of three", () => {
    test("Returns expected results", () => {
        ...
        expect(threeSum([-2, -1, 0, 1, 2])).toStrictEqual([
            [-2, 0, 2],
            [-1, 0, 1],
        ]);
        expect(threeSum([-4, -2, -2, -2, 0, 1, 2, 2, 2, 3, 3, 4, 4, 6, 6])).toStrictEqual([
            [-4, -2, 6],
            [-4, 0, 4],
            [-4, 1, 3],
            [-4, 2, 2],
    ...
    test("Returns only unique triples", () =>
...
describe("Letter combinations", () => {
    test("Returns expected results", () =>
        expect(lc("23")).toStrictEqual(["ad", "ae", "af", "bd", "be", "bf", "cd", "ce", "cf"]));
...
describe("Search in sorted shifted array", () => {
    ...
    test("Returns -1 if target is not found", () =>
...
describe("Search range", () => {
    ...
    test("Correctly returns if there's only one target value", () =>
        expect(searchRange([5, 7, 7, 8, 8, 10], 10)).toStrictEqual([5, 5]));
    test("Returns -1 if not found", () =>
        expect(searchRange([5, 7, 7, 8, 8, 10], 6)).toStrictEqual([-1, -1]));
    test("Correctly returns if array of length 1", () =>
